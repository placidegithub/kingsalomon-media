...
Updates the existing Placide account to admin with your credentials
"""
...
def update_placide_to_admin():
    """Update the existing Placide account to admin"""
...
if __name__ == '__main__':
    print("👤 King Salomon Academy - Update Placide to Admin")
    print("=" * 60)
    
    update_placide_to_admin()
