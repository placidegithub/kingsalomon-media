#!/usr/bin/env python3
"""
Complete System Demonstration - Simple Version
...
def demonstrate_system():
    ...
    try:
        ...
        print("ERROR - Application not running!")
    ...
    print("1. System validates credentials OK")
    print("2. System generates OTP code OK")
    print("3. System prints OTP to terminal OK")
    print("4. System redirects to verification page OK")
    ...
    try:
        ...
        if response.status_code == 302:
            print("OK - Login successful! OTP verification triggered")
